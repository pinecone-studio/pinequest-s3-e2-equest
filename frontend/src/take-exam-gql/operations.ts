...
export type FrontendDashboardAvailableTestFieldsFragment = { __typename?: 'Test', id: string, title: string, description: string, updatedAt: string, criteria: { __typename?: 'TestCriteria', gradeLevel: number, className: string, subject: string, topic: string, difficulty: string, questionCount: number } };
