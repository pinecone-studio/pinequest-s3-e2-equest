...
async function runScheduler(
	...
	/** Давхарга 3: ирээдүйд school_events хүснэгтээс уншиж prompt-д оруулна. Одоо хоосон. */
	const schoolEventBlockers: unknown[] = [];
...
ДАВХАРГА 1 — master_timetable (JSON, constraint): ${JSON.stringify(timetable)}
ДАВХАРГА 3 — school_events blockers (JSON, одоо хоосон): ${JSON.stringify(schoolEventBlockers)}
